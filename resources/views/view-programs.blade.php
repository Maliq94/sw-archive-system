        ...
        <div class="col-lg-12 mb-lg-0 mb-4">
          <div class="card">
            <div class="card-body p-3">
              <span class="text-danger pe-3 font-weight-bolder">قائمة البرامج | <a class="badge bg-gradient-success fs-6" href="/add-program">إضافة برنامج</a></span>
