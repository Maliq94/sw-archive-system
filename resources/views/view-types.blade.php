        ...
        <div class="col-lg-12 mb-lg-0 mb-4">
          <div class="card">
            <div class="card-body p-3">
              <span class="text-danger pe-3 font-weight-bolder">قائمة الأنواع | <a class="badge bg-gradient-success fs-6" href="/add-type">إضافة نوع</a></span>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-2">اسم النوع</th>
