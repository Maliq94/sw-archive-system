...
Route::get('/add-audio-tag-view/{id}', 'App\Http\Controllers\AudioController@addAudioTagView')->name('audiotag');
...
Route::get('/del-audio-tag/{audioId}/{id}', 'App\Http\Controllers\AudioController@tagDel');
...
Route::post('/add-audio-tag','App\Http\Controllers\AudioController@addAudioTag');
